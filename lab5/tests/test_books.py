...
def test_post_fields(client: FlaskClient):
    data = client.post("/books/", json=SAMPLE).get_json()
...
def test_post_unique_ids(client: FlaskClient):
    a = client.post("/books/", json=SAMPLE).get_json()
    b = client.post("/books/", json=SAMPLE).get_json()
...
def test_post_on_loan(client: FlaskClient):
    assert client.post("/books/", json={**SAMPLE, "status": "on_loan"}).get_json()["status"] == "on_loan"
...
def test_filter_pages_min(client: FlaskClient):
    client.post("/books/", json={**SAMPLE, "title": "Short", "pages": 50})
    client.post("/books/", json={**SAMPLE, "title": "Long", "pages": 500})
...
def test_get_200(client: FlaskClient):
    uid = client.post("/books/", json=SAMPLE).get_json()["id"]
...
def test_delete_leaves_others(client: FlaskClient):
    uid1 = client.post("/books/", json=SAMPLE).get_json()["id"]
    uid2 = client.post("/books/", json={**SAMPLE, "title": "Eneyida"}).get_json()["id"]
