...
def test_get_all_books_returns_all():
    ...
    client.post("/books/", json={**SAMPLE, "title": "Another Book"})
    response = client.get("/books/")
    assert response.status_code == 200
...
def test_combined_filter_and_sort():
    client.post("/books/", json={**SAMPLE, "title": "Z Book", "author": "Tolkien", "year": 2000, "status": "available"})
    client.post("/books/", json={**SAMPLE, "title": "A Book", "author": "Tolkien", "year": 1990, "status": "available"})
    client.post("/books/", json={**SAMPLE, "title": "M Book", "author": "Rowling", "year": 1995, "status": "available"})
